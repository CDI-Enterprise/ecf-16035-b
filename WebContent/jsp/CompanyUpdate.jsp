...
<% Company company = (Company) request.getAttribute("company"); %> 
		<form id= "companyForm" name= "companyForm" action=""  onreset="reset();" method="post">
			<div class="fieldset">
			<fieldset id="company" >
				...
				<input type="text" name="companyCity" id="companyCity" value="<%=company.getCity() %>" /> 
				<br /><br /> 
				<label for="companyPostalCode">Code postal: </label> 
				<input type="text" name="companyPostalCode" id="companyPostalCode" value="<%=company.getPostalCode() %>" /> 
				<br /><br /> 
				<label for="companyDepartment">Département: </label> 
				<input type = "text" name="companyDepartment" id="departments" value="<%=company.getDepartment().getDepartmentName() %>" /> 
				<br /><br /> 
				<label for="companyRegion">Région: </label> 
				<input type="text"	name="companyRegion" id="regions" value="<%=company.getRegion().getRegionName() %>" /> 
				<br /><br />
				<label for="companySize">Taille de l'entreprise</label>
				<input type ="text" name="companySize" id = "companySize" value="<%=company.getSize() %>"/>
				<br/><br/>
				<label for="companySector">Secteur d'activité</label>
				<input type="text" name="companySector" id="companySector" value="<%=company.getSector() %>" >
				<br/><br/>
				<label for="companyLanguages">Langages principalement utilis&eacute;s</label>
				<input type="text" name ="companyLanguages" id="languages" value="<%=company.getLanguage() %>">  
				<br/><br/>
				<label for="companyProjects">Principaux projets de l'entreprise</label>
				<textarea  name="companyProjects" value="<%=company.getProjets() %>" ></textarea> 
				<br/><br/>
				<label for="companyWebSite">Site Web: </label> 
				<input type="text" name="companyWebSite" id="companyWebSite" value="<%=company.getWebSite() %>"> 
				<br /><br /> 
			</fieldset>
			</div>
			<br />
